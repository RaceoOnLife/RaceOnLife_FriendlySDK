...
bool FAvaturnAvatarStorage::AvatarExists(const FAvatarUri& AvatarUri)
{
...
void FAvaturnAvatarStorage::SaveAvatar(const FString& GlbFilePath, const TArray<uint8>& Data)
{
...
void FAvaturnAvatarStorage::ClearAvatar(const FString& Guid)
{
	DeleteDirectory(GetAvatarCacheDir() + Guid);
}

int32 FAvaturnAvatarStorage::GetAvatarCount()
{
