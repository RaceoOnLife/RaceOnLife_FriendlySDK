...
struct AVATURN_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct AVATURN_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct AVATURN_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
...
UCLASS()
class AVATURN_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
    /**
