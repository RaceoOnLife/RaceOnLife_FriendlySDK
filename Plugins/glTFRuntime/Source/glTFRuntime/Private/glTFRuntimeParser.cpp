...
void FglTFRuntimeParser::LoadAndFillBaseMaterials()
{
	...
	// for Avaturn Editor (hair ramp)
	UMaterialInterface* TranslucentRampMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/glTFRuntime/M_Ramp_glTFRuntimeTranslucent_Inst"));
	if (TranslucentRampMaterial)
	{
		RampMetallicRoughnessMaterialsMap.Add(EglTFRuntimeMaterialType::Translucent, TranslucentRampMaterial);
	}

	UMaterialInterface* TwoSidedRampMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/glTFRuntime/M_Ramp_glTFRuntimeTwoSided_Inst"));
	if (TranslucentRampMaterial)
	{
		RampMetallicRoughnessMaterialsMap.Add(EglTFRuntimeMaterialType::TwoSided, TwoSidedRampMaterial);
	}

	UMaterialInterface* TwoSidedTranslucentRampMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/glTFRuntime/M_Ramp_glTFRuntimeTwoSidedTranslucent_Inst"));
	if (TranslucentRampMaterial)
	{
		RampMetallicRoughnessMaterialsMap.Add(EglTFRuntimeMaterialType::TwoSidedTranslucent, TwoSidedTranslucentRampMaterial);
	}

	UMaterialInterface* MaskedRampMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/glTFRuntime/M_Ramp_glTFRuntimeMasked_Inst"));
	if (TranslucentRampMaterial)
	{
		RampMetallicRoughnessMaterialsMap.Add(EglTFRuntimeMaterialType::Masked, MaskedRampMaterial);
	}

	UMaterialInterface* TwoSidedMaskedRampMaterial = LoadObject<UMaterialInterface>(nullptr, TEXT("/glTFRuntime/M_Ramp_glTFRuntimeTwoSidedMasked_Inst"));
	if (TranslucentRampMaterial)
	{
		RampMetallicRoughnessMaterialsMap.Add(EglTFRuntimeMaterialType::TwoSidedMasked, TwoSidedMaskedRampMaterial);
	}
